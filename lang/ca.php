...
$langSetup["dbconnectfailed"] = "Error connectant amb la base de dades.";
...
$langSetup["disabledesc"] = "Deixar el script accessible és un risc de seguretat molt greu. Qualsevol persona podria executar-lo, esborrar la base de dades i crear un nou usuari. Esborra el fitxer o desactiva'l posant el valor %s a %s."; // substitutes variable name and value
$langSetup["setupfailed"] = "Alguna cosa ha fallat. Provi a trobar més informació als logs del servidor web.";
$langSetup["welcome"] = "Benvongut a µlogger!";
...
$langSetup["createconfig"] = "Crear el fitxer 'config.php' al directori arrel. Pot crear-lo a partir del fitxer  'config.default.php'. Assegureu-vos de modificar les dades relatives a la base de dades amb els vostres paràmetres.";
$langSetup["nodbsettings"] = "Heu d'indicar les credencials de la base de dades al fitxer 'config.php'  (%s)."; // substitutes variable names
$langSetup["scriptdesc"] = "Aquest script crearà les taules necessàries per a µlogger (%s). Es crearan a la vostra base de dades %s. Atenció, si les taules existeixen s'esborraran i seran creades de nou, destruint les dades existents."; // substitutes table names and db name
...
$lang["newpasswordrepeat"] = "Repeteixi la nova contrasenya";
...
$lang["userdelwarn"] = "Precaució!\n\nEsborraràs permanentement l'usuario %s, totes les seves rutes i posicions.\n\nEstàs segur?"; // substitutes user login

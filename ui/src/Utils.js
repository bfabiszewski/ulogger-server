...
export default class Utils {
  ...
  static loadScript(url, id, ms = 10000) {
    const scriptLoaded = new Promise(
      (resolve, reject) => Utils.addScript(url, id, resolve, reject));
  ...
  static getFloat(input, isNullable = false) {
    return Utils.getParsed(input, isNullable, 'float');
  }
  ...
  static getInteger(input, isNullable = false) {
    return Utils.getParsed(input, isNullable, 'int');
  }
  ...
  static getString(input, isNullable = false) {
    return Utils.getParsed(input, isNullable, 'string');
  }
